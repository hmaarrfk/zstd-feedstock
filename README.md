...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/zstd-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/zstd-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add zstd zstd-static
# for installing globally
pixi global install zstd zstd-static
```
...
It is possible to list all of the versions of `zstd` available on your platform:
...
```
pixi search zstd --channel conda-forge
```
